...
import { dbPromise } from '../../../utils/dbSetup'; // Adjust path: up two levels
...
export default function ChaptersScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-900">
            {/* Set the header title dynamically using Stack.Screen */}
            <Stack.Screen options={{ title: collectionName || "Chapters" }} />
