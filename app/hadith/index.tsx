...
export default function HadithCollectionsScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-900">
            {/* Wrap header and list in a flex-1 view to push nav bar down */}
            <View className="flex-1">
                ...
                <FlatList
                    ...
                    // Add paddingBottom to avoid overlap with absolute nav bar
            ...
            {/* BottomNavBar is outside the flex-1 view, positioned absolutely */}
            <BottomNavBar />
        </SafeAreaView>
    );
}
